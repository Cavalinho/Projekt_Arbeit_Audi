module ApplicationHelper
	...
	def kpi_column(day, y)
		...
		# daten[0] = Wochentag (Montag => 1), daten[1] = Montageübegaben diese Woche,
		case day

		when 1

				left = 64.5
				"<div class='kpi-column' style='bottom: 125px;left: #{left}px;height:#{y * 17.8 + 20}px' ></div>"
		...
		when 2
				...
				#Monday
				#"<div class='kpi-column' style='bottom: 125px; height:#{daten[2] * 17.8 + 20}px' ></div>"
		...
		when 3
				...
				#Monday
				#"<div class='kpi-column' style='bottom: 125px;left: 64px;height:#{daten[2] * 17.8 + 20}px' ></div>"

				#Tuesday
				#"<div class='kpi-column' style='bottom: 125px;left: 125px;height:#{datentday[0] * 17.8 + 20}px' ></div>"
		...
		when 4
				...
				#Wednesday
				#"<div class='kpi-column' style='bottom: 125px;left: 189.5px;height:#{datenwday[0] * 17.8 + 20}px' ></div>"
		...
		when 5
				...
				#Thursday
				#"<div class='kpi-column' style='bottom: 125px;left: 251.5px;height:#{datenthday[0] * 17.8 + 20}px' ></div>"
